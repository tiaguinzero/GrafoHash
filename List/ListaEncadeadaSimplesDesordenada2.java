...
public class ListaEncadeadaSimplesDesordenada2 <TpIdX extends Comparable<TpIdX>, X extends Identificavel<TpIdX>> implements Cloneable
{
	...
	public ListaEncadeadaSimplesDesordenada2(){
		this.primeiro = null;
	}
    ...
    */
	...
	public boolean equals (Object obj)
	{
		...
		No atualDoObj  = ((ListaEncadeadaSimplesDesordenada2<TpIdX, X>)obj).primeiro;
	...
	public ListaEncadeadaSimplesDesordenada2 (ListaEncadeadaSimplesDesordenada2<TpIdX, X> modelo) throws Exception
	{
		if (modelo==null) throw new Exception ("Modelo ausente");
	...
	public Object clone ()
	{
		ListaEncadeadaSimplesDesordenada2<TpIdX, X> ret=null;
		
		try
		{
			ret = new ListaEncadeadaSimplesDesordenada2 (this);
		}
		catch (Exception erro)
		{} // sei que nao vai dar erro, pois o construtor de cópia só da erro ao receber parâmetro null, e o que estou passando como parâmetro para ele é o this, que NUNCA, NUNQUINHA MESMO, é null
